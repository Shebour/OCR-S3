 ...
 */
 res = SDL_CreateRGBSurface(SDL_SWSURFACE, picture->w, picture->h, picture->format->BitsPerPixel,
			picture->format->Rmask, picture->format->Gmask, picture->format->Bmask, picture->format->Amask);
